...
export const ActiveFiltersSchema = z.object({
	// only 1 date filter
	date: z.tuple([z.enum(CLIP_SEARCH_FILTER_DATES)]).nullish(),
	format: z.array(z.enum(CLIP_SEARCH_FILTER_FORMATS)).nullish(),
	duration: z.array(z.enum(CLIP_SEARCH_FILTER_DURATIONS)).nullish(),
	resolution: z.array(z.enum(CLIP_SEARCH_FILTER_RESOLUTIONS)).nullish(),
	price: z.array(z.enum(CLIP_SEARCH_FILTER_PRICES)).nullish(),
...
export const DataClipSchema = z.object({
	...
	thumb: z.string(),
	thumbs: ThumbsSchema,
	mediabook_url: z.string().nullable(),
	mediabook_quality: z.string().nullable(),
	video_preview_link: z.string().nullable(),
	cdn_previewlg_link: z.string(),
	cdn_preview_link: z.string(),
	checkout_link: z.string(),
